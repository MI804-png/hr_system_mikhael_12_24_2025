...
INSTALLED_APPS = [
    ...
    'apps.recruitment',
    'apps.benefits',
    # 'apps.compliance',  # Replaced by apps.hr_compliance
    # 'apps.relations',  # Merged into retention_management
    'apps.performance',
    'apps.training',
    'apps.search',
    'apps.ai_assistant',
    ...
    'apps.budgeting',
    'apps.compensation',
    'apps.financial_compliance',
    'apps.financial_planning',
    
    # Strategic HR & Operations
    'apps.equity_management',
    'apps.csr_sustainability',
    'apps.retention_management',
    'apps.data_export_import',
...
SALARY_CALCULATION_DAY = 1  # 1st of each month
